<section class="main-massage">
    <div class="main-massage__header">
        ...
        <div class="massage-header__short-hand">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="#f6f6f6" class="bi bi-search"
                viewBox="0 0 16 16">
                <path
                    d="M11.742 10.344a6.5 6.5 0 1 0-1.397 1.398h-.001q.044.06.098.115l3.85 3.85a1 1 0 0 0 1.415-1.414l-3.85-3.85a1 1 0 0 0-.115-.1zM12 6.5a5.5 5.5 0 1 1-11 0 5.5 5.5 0 0 1 11 0" />
            </svg>
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="#f6f6f6" class="bi bi-telephone"
                viewBox="0 0 16 16">
                <path
            ...
            <svg xmlns="http://www.w3.org/2000/svg" height="20" width="20" fill="#f6f6f6"
    ...
    <div class="send-massage">
        <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="#f6f6f6" class="bi bi-paperclip"
            viewBox="0 0 16 16">
            <path
                d="M4.5 3a2.5 2.5 0 0 1 5 0v9a1.5 1.5 0 0 1-3 0V5a.5.5 0 0 1 1 0v7a.5.5 0 0 0 1 0V3a1.5 1.5 0 1 0-3 0v9a2.5 2.5 0 0 0 5 0V5a.5.5 0 0 1 1 0v7a3.5 3.5 0 1 1-7 0z" />
        </svg>
        <input type="text" placeholder="Write a massage..." id="MessageBox">
        <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="#f6f6f6" class="bi bi-mic"
            viewBox="0 0 16 16">
            <path
        ...
        <button type="submit" class="send" onclick="sendMessage()">
            <svg xmlns="http://www.w3.org/2000/svg" width="23" height="23" fill="#f6f6f6" class="bi bi-send"
                viewBox="0 0 16 16">
                <path

...
<head>
    ...
    @vite(['resources/js/tailwindcss.js', 'resources/js/app.js', 'resources/js/validation.js'])
</head>
    ...
    <div class="flex min-h-screen items-center justify-center">
        ...
        <div class="min-h-1/2 bg-gray-900  border border-gray-900 rounded-2xl">
            ...
            <div
                ...
                <h1 class="text-white text-2xl">Login to chat with others... 😄</h1>
...
<script>
    const login = () => {
        ...
        try {
            validation.user.parse(username)
        } catch (error) {
            return toaster.danger(
                "Oops! It looks like there's an issue with your username. Please ensure it contains only letters from A to Z, both uppercase and lowercase. Thanks!"
            )
        }
